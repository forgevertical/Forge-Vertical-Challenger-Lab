# 📝 Forge Vertical // Candidate Assessment Questionnaire

> **Directive:** Complete these questions and include them in your final submission email. Precision and professional integrity are the only metrics that matter.
...
**2. Stealth & Persistence:** If this were a real-world production environment with 50,000+ lines of code, how would you modify your `linter.sh` payload to bypass a manual code review by a senior DevOps engineer?

**3. Tooling:** What is your primary stack for binary deconstruction and network interception? (e.g., Ghidra, Burp Suite Professional, GDB, etc.)
...
**5. Disclosure Protocol:** You find a Critical (P1) vulnerability that is outside the specific "Brief" I gave you. Do you:
   a) Exploit it to show the full impact?
   b) Report it immediately without further interaction?
   c) Ignore it as it is out of scope?
...
---
*“A bug is a mistake. An exploit is an observation.”*
